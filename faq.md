...
<div class="faq-container">
  ...
  <p class="faq-lead">No marketing fluff. Just direct answers about the mechanics of the audit.</p>
  ...
  <div class="faq-section">
    ...
    <div class="faq-item">
      ...
      <div class="faq-answer">
        <p>Free scanners simulate one parser and output a guess. They cannot see your file's underlying architecture—the tables, text boxes, or header/footer traps that cause actual parsing failures. Our audit is Human-in-the-Loop (HIL): a human reviewer performs the diagnostic tests that AI cannot execute, then uses AI to accelerate keyword analysis. The final judgment is human. We distinguish between what we can confirm and what is only likely.</p>
      </div>
    </div>
    ...
    <div class="faq-item">
      ...
      <div class="faq-answer">
        <p>AI cannot open your file, press Ctrl+A, or visually confirm a text box. It cannot run the Brutal Copy-Paste Test and interpret the scrambled output. Our advantage is simple: we perform the manual, mechanical tests that are still required for a reliable audit. AI assists; the human verifies. This prevents the false certainty that pure automation sells.</p>
      </div>
    </div>
  </div>
  ...
  <div class="faq-section">
    ...
    <div class="faq-item">
      ...
      <div class="faq-answer">
        <p>The first and most critical test. We manually copy all text from your resume file and paste it into a plain-text editor. If the output is scrambled, out of order, or missing data (contact info, dates), your resume will fail in an ATS. This is a mechanical reality, not an opinion. We perform it on every audit.</p>
      </div>
    </div>
    ...
    <div class="faq-item">
      ...
      <div class="faq-answer">
        <p>A PDF is sufficient for a strong audit. We can assess text extraction, keyword gaps, and visible structure. However, if you provide the source .DOCX, we can also inspect the document architecture for hidden risks—tables, text boxes, headers/footers. We will never claim to confirm something we cannot see. The .DOCX provides the highest confidence.</p>
      </div>
    </div>
    ...
    <div class="faq-item">
      ...
      <div class="faq-answer">
        <p>A screenshot shows only visual appearance. An ATS is a text extraction engine, not a pair of eyes. We need the actual file to test how the machine-readable text layer behaves. Images reveal nothing about parsing.</p>
      </div>
    </div>
  ...
  <div class="faq-section">
    ...
    <div class="faq-item">
      ...
      <div class="faq-answer">
        <p>AI is our acceleration layer. It quickly compares your resume text to the job description, identifies keyword gaps, spots weak bullets, and suggests concise rewrites. This allows our human reviewer to focus on the tasks AI cannot do: file structure inspection, extraction testing, and nuanced judgment.</p>
      </div>
    </div>

    <div class="faq-item">
      <button class="faq-question">Can't I just use ChatGPT myself?</button>
      <div class="faq-answer">
        <p>You can, and it might help with phrasing. But AI alone cannot:
        <ul>
        ...
        Our value is the synthesis: human verification augmented by AI efficiency.</p>
      </div>
    </div>
  </div>
  ...
  <div class="faq-section">
    ...
    <div class="faq-item">
      ...
      <div class="faq-answer">
        <p>A clear, actionable document containing:
        <ul>
    ...
    <div class="faq-item">
      ...
      <div class="faq-answer">
        ...
        Send them to <strong>audit@stoicresume.com</strong> after payment.</p>
      </div>
    </div>
  </div>
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  questions.forEach(button => {
    button.addEventListener('click', function() {
      ...
      // Close all others (optional, for an accordion)
